...
class RejectedViewController: UIViewController {
    ...
    func loadTasks() {
        ...
        self.tasks = [
            [
                "title": "Task 1",
                "desc": "Fix the dashboard alignment issue",
                "remark": "Incomplete layout implementation"
            ],
            [
                "title": "Task 2",
                "desc": "Create onboarding flow for new users",
                "remark": ""
            ]
        ]
...
extension RejectedViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "RejectedCollectionViewCell", for: indexPath) as! RejectedCollectionViewCell
