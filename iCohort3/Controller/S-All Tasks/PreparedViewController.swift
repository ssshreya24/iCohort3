...
class PreparedViewController: UIViewController {
    ...
    func loadTasks() {
        self.tasks = [
            ["title": "Task 1", "desc": "Prepare final documentation"]
        ]
...
extension PreparedViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PreparedCollectionViewCell", for: indexPath) as! PreparedCollectionViewCell
        ...
        // Just for display — disable interaction
        cell.circleButton.isUserInteractionEnabled = false
        
        // Make circle button blue (#007BFF)
