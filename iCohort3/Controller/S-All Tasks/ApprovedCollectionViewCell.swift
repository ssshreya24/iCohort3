////
////  ApprovedCollectionViewCell.swift
////  iCohort3
////
...
//    @IBOutlet weak var remarkTitleLabel: UILabel!       // "Remark"
//    @IBOutlet weak var remarkDescLabel: UILabel!        // remark text
...
//        circleButton.backgroundColor = UIColor(red: 0.30, green: 0.75, blue: 0.39, alpha: 1.0) // #4CAF50
...
//    }
//    
//    func configure(title: String, desc: String, remark: String?, image: UIImage?, name: String) {
...
//            remarkDescLabel.isHidden = false
//            remarkDescLabel.text = remark
//        } else {
//            remarkTitleLabel.isHidden = true
//            remarkDescLabel.isHidden = true
//        }
//    }
//}
